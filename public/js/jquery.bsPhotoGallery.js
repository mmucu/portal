(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
          ...
          html += '<a class="controls previous" style="float:left" data-bsp-id="'+clicked.ulId+'" href="' + (clicked.prevImg) + '">&laquo; prev</a>';
          html += '<a class="controls next" style="float:right" data-bsp-id="'+clicked.ulId+'" href="'+ (clicked.nextImg) + '">next &raquo;</a>';
          html += '</div>';
